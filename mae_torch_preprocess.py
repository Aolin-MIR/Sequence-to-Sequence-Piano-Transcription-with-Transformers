...
def tokenize(midfile, audio,method='cqt'):
    ...
    if method=='cqt':
        ...
        frames = librosa.feature.melspectrogram(frames, sr=sample_rate, n_fft=256, hop_length=256, n_mels=512)
...
if __name__ == "__main__":
    ...
    path = '/home/lal/maestro-v3.0.0'
    # path = '/mnt/data/piano/workspace/midi/original'
    output_file ='mae_0.02_31_melspec_2048_12800_train.tfrecord'
